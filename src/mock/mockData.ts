...
export const rows: DataType[] = [
    { id: 1, dni: 20839754, lastName: 'Snow', firstName: 'Jon', number: 1123441102, sede: 'Almagro', active: 'X', ultimaFechaDePago: new Date('2023-11-27T12:00:00'), proximoVencimiento: new Date('2023-12-27T12:00:00')},
