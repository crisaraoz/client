...
export default function Home() {
    ...
    return (
        ...
        <Toolbar style={{backgroundColor: "black"}}>
            ...
            < AccountCircleIcon component={Link} to="mi-perfil" style={{backgroundColor: "white", color: "black"}}/>
        </Toolbar>
        ...
        <Box sx={{ display: 'flex' , marginTop: '64px'}}>
                ...
                >
                    <List >
                        ...
                        style={{ backgroundColor: selectedItem === 'usuarios' ? '#1d97dd' : 'transparent' }}
                         >
                            <ListItemIcon>
                                <PeopleIcon />
                            </ListItemIcon>
                        ...
                        style={{ backgroundColor: selectedItem === 'validar-socio' ? '#1d97dd' : 'transparent' }}
                        >
                            <ListItemIcon>
                                <CheckIcon />
                            </ListItemIcon>
